...
ps_na_Class.top12_Class_arpil <- subset_samples(ps_na_Class.top12_phyla, Month == "April")
ps_na_Class.top12_Class_july <- subset_samples(ps_na_Class.top12_phyla, Month == "July")
...
Сlass_colors <- c(
  ...
  "Isochrysidales" = "#17becf",
  "Prymnesiales" = "#1a55FF",
  "Pelagophyceae" = "#8B572A"
)
...
ggsave("relative_abundance_Class_top12_april_275_v132.jpeg", plot = relative_abundance_Class_top12_april, width = 10, height = 6, dpi = 300)
...
ggsave("relative_abundance_Class_top12_july_275_v132.jpeg", plot = relative_abundance_Class_top12_july, width = 10, height = 6, dpi = 300)
